 ...
 *  Implementa el concepto de Persona seg˙n el modelo 2.
 *  @since: prototipo2.0
 *  @source: Persona.java 
 *  @version: 2.0 - 2018/03/14 
 *  @author: Marcos MartÌnez - Grupo 3
 */
...
public class Persona implements Serializable {
	...
	/**
	 * Constructor convencional. Utiliza m√©todos set...()
	 * @param nif
	 * @param nombre
	 * @param apellidos
	 * @param domicilio
	...
	/**
	 * Constructor por defecto. Reenv√≠a al constructor convencional.
	 * @throws ModeloException 
	 */
	...
	public void setFechaNacimiento(Fecha fechaNacimiento) throws ModeloException {
		...
		if (fechaNacimientoValida(fechaNacimiento)) {
			...
			throw new ModeloException("Persona: fecha de nacimiento no v√°lida.");
		}
	}
	...
	private boolean fechaNacimientoValida(Fecha fechaNacimiento) {
		// Debe ser fecha del pasado, al menos 16 a√±os.
		Fecha fechaNacimientoMinima = new Fecha();
		fechaNacimientoMinima.addAÒos(-16);
